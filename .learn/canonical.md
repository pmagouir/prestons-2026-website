...
- Agentic workflows (Preston ruling 2026-09-23): approved phrasing "I build agentic AI workflows that support our analytics, engineering, web publishing, and grant research and writing, with an audit trail on every output." NEVER say or imply the Development team's work is automated; no "production agent pipeline" / "five-agent pattern" / grant-prospecting-pipeline copy.
...
- **Supervisory span:** 5 direct reports (Preston, 2026-09-23; JD says "approximately six" — Preston's count wins), including direct supervision of the Chief Programs Officer. Approved for the site (recruiters reward demonstrated executive scope). Aggregate framing only; no named reports.
...
- **FY26 Impact Report — public** at https://impact.dccap.org/ — **Comms' artifact: link it as evidence (hero CTA, pivot card, About, Experience), never a portfolio card** (Preston, 2026-09-23: "let's save some glory for comms") (live 2026-09-22, `BRAIN/projects/impact_report_fy26/final/DEPLOY_RECEIPT.md`). Attribution: "we" — Preston built the structure and shipped it; DC CAP Comms owns the design and copy. Link freely; cite only figures also registered here.
...
- **No neighborhood priority (Preston, 2026-09-23: "no neighborhood priority anymore. stop"):** the match no longer uses neighborhood (Ward 7/8) priority — never describe it as a feature.
- **Matching framing (Preston, 2026-09-23):** student-proposing stable matching on MUTUAL preferences (scholars rank partners, partners rate applicants); never "weighs applicants against partners" (`BRAIN/projects/matching_2026/Matching_2026_Project.md:12`).
- **Matching top-choice rate (registered 2026-09-23):** 83.5% of 2026 matched scholars landed their top-choice partner — public on the Evidence Room (PDP `qa/claims_ledger.csv` row 34, verify gate). **Disbursement:** Preston redesigned the disbursement workflow (pledge → general ledger reconciliation, named owner per step; `BRAIN/personal/fy2026_contributions.md` §Standards of Practice).
...
- NPR Marketplace, "Some colleges opt for direct admissions" — https://www.marketplace.org/story/2022/08/15/automatic-college-admissions-can-be-a-boon-to-students-and-schools-alike (URL moved to /story/ path; verified in browser 2026-09-23)
- CNBC, "College admission applications spike" — https://www.cnbc.com/2021/12/07/college-admission-applications-spike-as-january-deadline-nears.html (URL corrected 2026-09-23: the 2023 slug 404'd; verified via search: Magouirk quoted as Common App data scientist)
...
- The 74 / Early Learning Nation, "The Path to Quality Child Care" — https://www.the74million.org/zero2eight/the-path-to-quality-child-care-just-became-a-little-less-elusive-new-research-shows-star-rating-systems-can-drive-improvement-at-scale/ (ELN URL 404'd 2026-09-23; The 74 copy verified in browser)
